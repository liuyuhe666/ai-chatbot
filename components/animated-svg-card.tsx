...
interface AnimatedSvgCardProps {
  width?: number
  height?: number
  titleSize?: string
  titleText?: string
...
const AnimatedSvgCard: React.FC<AnimatedSvgCardProps> = ({
  width = 800,
  height = 400,
  titleSize = 'text-5xl',
    ...
    >
      <foreignObject height={height} width={width}>
        <div>
          ...
          <div
            className={`animated-svg-card w-full h-full flex flex-col items-center justify-center m-0 rounded-t-lg ${
